...
- 💬 Ask me about **REST APIs, JWT Auth, MongoDB**
...
- ☁️ Deployed on **Netlify** (Frontend) + **Render** (Backend) + **MongoDB Atlas**
- 🎨 Clean, responsive UI built with vanilla HTML, CSS, JS

**Live:** [my-todo-frontend.netlify.app](https://my-todo-frontend.netlify.app) &nbsp;|&nbsp; **Code:** [github.com/hiten-developer/todo-app](https://github.com/hiten-developer/todo-app)
